...
public static class AssignmentAnswerDeletedHandler
{
    public class ToIntegration(IEventBus eventBus, ApplicationDbContext context)
        : IEventHandler<AssignmentAnswerDeletedEvent>
    {
        public async Task Handle(AssignmentAnswerDeletedEvent notification, CancellationToken cancellationToken)
        {
            List<Guid> students;
