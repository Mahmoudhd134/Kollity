using Kollity.Services.Application.Commands.Assignment.Group.AcceptInvitation;
using Kollity.Services.Application.Commands.Assignment.Group.AddGroup;
using Kollity.Services.Application.Commands.Assignment.Group.CancelInvitation;
using Kollity.Services.Application.Commands.Assignment.Group.DeclineInvitation;
using Kollity.Services.Application.Commands.Assignment.Group.DeleteStudent;
using Kollity.Services.Application.Commands.Assignment.Group.Leave;
using Kollity.Services.Application.Commands.Assignment.Group.SendInvitation;
using Kollity.Services.Application.Dtos.Assignment.Group;
using Kollity.Services.Application.Queries.Assignment.Group.GetAll;
