...
namespace Kollity.Reporting.Persistence.Migrations
{
    ...
    [Migration("20240514165146_AddRoomContentTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kollity.Reporting.Domain.RoomModels.RoomContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("RoomContent", "reporting");
                });
            ...
            modelBuilder.Entity("Kollity.Reporting.Domain.CourseModels.CourseDoctorAndAssistants", b =>
                {
                    b.HasOne("Kollity.Reporting.Domain.CourseModels.Course", "Course")
                        .WithMany("CourseDoctorAndAssistants")
            ...
            modelBuilder.Entity("Kollity.Reporting.Domain.RoomModels.RoomContent", b =>
                {
                    ...
                    b.HasOne("Kollity.Reporting.Domain.UserModels.User", "Uploader")
                        .WithMany()
                        .HasForeignKey("UploaderId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_room_content_users_uploader_id");
            ...
            modelBuilder.Entity("Kollity.Reporting.Domain.CourseModels.Course", b =>
                {
                    b.Navigation("CourseDoctorAndAssistants");
